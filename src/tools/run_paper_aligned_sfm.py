...
def main() -> int:
    ...
    parser.add_argument("--optimize-shared-focal", action="store_true", default=True)
    parser.add_argument("--disable-shared-focal-optimization", action="store_false", dest="optimize_shared_focal")
    ...
    parser.add_argument("--filter-after-ba", action="store_true", default=True)
    parser.add_argument("--disable-filter-after-ba", action="store_false", dest="filter_after_ba")
